$(document).ready(function () {
    $('.select2').select2();
    $('#type_of_observation').on('change', onTypeOfObservationChange)
    
    onTypeOfObservationChange()
    addValidation();
})

function onTypeOfObservationChange() {
    if ($('#type_of_observation').val() == "Non Confirmnace") {
        
        $('#number_of_observation').parent().show()
        $('#area_of_concern').parent().show()
        $('#count_of_observation').parent().hide()

        $('.non').css('display', 'block');
        $('.good').css('display', 'none');
        $('.placeholder_confirmnace').css('display', 'none');
    }
    else if ($('#type_of_observation').val() == "Good Observation") {
        
        $('#number_of_observation').parent().show()
        $('#area_of_concern').parent().hide()
        ...
        $('#area_of_concern').parent().hide()
        $('#number_of_observation').parent().hide()
...
function SubmitQAObservation() {
    if ($('#qa-observation-form').valid()) {
        ...
        myData.append("number_of_observation", $('#number_of_observation').val())
        myData.append("area_of_concern", $('#area_of_concern').val())
        ...
        var dataToSend = {
            ...
            number_of_observation: $('#number_of_observation').val(),
            area_of_concern: $('#area_of_concern').val(),
            count_of_observation: $('#count_of_observation').val(),
        }
...
window.onCritical = onCritical
window.SubmitQAObservation = SubmitQAObservation