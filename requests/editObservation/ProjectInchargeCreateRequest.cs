...
{
    public class ProjectInchargeCreateRequest: ObservationFlowRequest
    {
        [Required]
        ...
        {
            var validator = new ProjectInchargeCreateRequestValidator();
    ...
    public class ProjectInchargeCreateRequestValidator : AbstractValidator<ProjectInchargeCreateRequest>
    {
        public ProjectInchargeCreateRequestValidator()
        {
